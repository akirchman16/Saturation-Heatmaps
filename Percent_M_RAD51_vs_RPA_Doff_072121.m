...
% Percent_M_RAD51 and k_off_RPA_D. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(Percent_M_RAD51_Values,k_off_RPA_D_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: Percent_M_RAD51 and k_off_RPA_D)
...
[X_Heatmap,Y_Heatmap] = meshgrid(Percent_M_RAD51_Values,k_off_RPA_D_Values); %generates X and Y values for heatmaps
