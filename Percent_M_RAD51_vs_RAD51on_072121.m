...
% Percent_M_RAD51 and k_on_RAD51. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(Percent_M_RAD51_Values,k_on_RAD51_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: Percent_M_RAD51 and k_on_RAD51)
...
[X_Heatmap,Y_Heatmap] = meshgrid(Percent_M_RAD51_Values,k_on_RAD51_Values); %generates X and Y values for heatmaps
