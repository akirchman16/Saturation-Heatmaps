...
% k_off_RAD51 and L_RPA. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(k_off_RAD51_Values,L_RPA_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: k_off_RAD51 and L_RPA)
...
P2 = Heatmap_Parameters(2,:);  %Temp. variable (for L_RPA) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    L_RPA = P2(Simulations);    %concentration of RPA
...
[X_Heatmap,Y_Heatmap] = meshgrid(k_off_RAD51_Values,L_RPA_Values); %generates X and Y values for heatmaps
