...
% k_off_RPA_A and k_off_RPA_D. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(k_off_RPA_A_Values,k_off_RPA_D_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: k_off_RPA_A and k_off_RPA_D)
...
P1 = Heatmap_Parameters(1,:);  %Temp. variable (for k_off_RPA_A) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_off_RPA_A = P1(Simulations); %kinetic rate constant for unbinding of RPA-A
...
[X_Heatmap,Y_Heatmap] = meshgrid(k_off_RPA_A_Values,k_off_RPA_D_Values); %generates X and Y values for heatmaps
