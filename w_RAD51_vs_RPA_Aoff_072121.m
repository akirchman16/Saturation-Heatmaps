...
% w_RAD51 and k_off_RPA_A. It allows for plotting the growth 
...
k_off_RPA_A_Values = linspace(1,100,2); %kinetic rate constant for RPA-A dissociating from ssDNA
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(w_RAD51_Values,k_off_RPA_A_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: w_RAD51 and k_off_RPA_A)
...
[X_Heatmap,Y_Heatmap] = meshgrid(w_RAD51_Values,k_off_RPA_A_Values); %generates X and Y values for heatmaps
