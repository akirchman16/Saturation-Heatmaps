...
k_on_RAD51_Values = 1:1:10;     %kinetic rate constant for RAD51 binding to ssDNA
k_off_RAD51_Values = 1:1:10;    %kinetic rate constant for RAD51 dissociating from ssDNA
