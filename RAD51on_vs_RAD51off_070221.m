...
k_on_RAD51_Values = linspace(1,10,5);     %kinetic rate constant for RAD51 binding to ssDNA
k_off_RAD51_Values = linspace(1,10,5);    %kinetic rate constant for RAD51 dissociating from ssDNA
