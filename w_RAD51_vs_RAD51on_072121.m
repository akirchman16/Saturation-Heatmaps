...
% w_RAD51 and k_on_RAD51. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(w_RAD51_Values,k_on_RAD51_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: w_RAD51 and k_on_RAD51)
...
P2 = Heatmap_Parameters(2,:);  %Temp. variable (for k_on_RAD51) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_on_RAD51 = P2(Simulations);    %kinetic rate constant for binding of RAD51
...
[X_Heatmap,Y_Heatmap] = meshgrid(w_RAD51_Values,k_on_RAD51_Values); %generates X and Y values for heatmaps
