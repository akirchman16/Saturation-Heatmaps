...
% k_on_RAD51 and k_off_RPA_D. It allows for plotting the growth 
...
k_on_RAD51_Values = linspace(1,10,2);     %kinetic rate constant for RAD51 binding to ssDNA
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(k_on_RAD51_Values,k_off_RPA_D_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: k_on_RAD51 and k_off_RPA_D)
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_on_RAD51 = P1(Simulations); %kinetic rate constant for binding of RAD51
...
[X_Heatmap,Y_Heatmap] = meshgrid(k_on_RAD51_Values,k_off_RPA_D_Values); %generates X and Y values for heatmaps
