...
% k_on_RAD51 and L_RPA. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(k_on_RAD51_Values,L_RPA_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: k_on_RAD51 and L_RPA)
...
[X_Heatmap,Y_Heatmap] = meshgrid(k_on_RAD51_Values,L_RPA_Values); %generates X and Y values for heatmaps
