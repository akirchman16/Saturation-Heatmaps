...
% Percent_M_RAD51 and w_RAD51. It allows for plotting the growth 
...
w_RAD51_Values = linspace(0,10,2);    %cooperativity parameter for RAD51
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(Percent_M_RAD51_Values,w_RAD51_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: Percent_M_RAD51 and w_RAD51)
...
P2 = Heatmap_Parameters(2,:);  %Temp. variable (for w_RAD51) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    w_RAD51 = P2(Simulations);    %cooperativity parameter of RAD51
...
[X_Heatmap,Y_Heatmap] = meshgrid(Percent_M_RAD51_Values,w_RAD51_Values); %generates X and Y values for heatmaps
