...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(L_RAD51_Total_Values,k_on_RAD51_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: L_RAD51_Total and k_on_RAD51)
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_on_RAD51 = P2(Simulations);    %percentage of RAD51 solution which is monomers
...
[X_Heatmap,Y_Heatmap] = meshgrid(L_RAD51_Total_Values,k_on_RAD51_Values); %generates X and Y values for heatmaps
