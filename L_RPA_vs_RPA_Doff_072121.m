...
% L_RPA and k_off_RPA_D. It allows for plotting the growth 
...
L_RPA_Values = linspace(1,10,2);  %concentration of RPA in solution
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(L_RPA_Values,k_off_RPA_D_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: L_RPA and k_off_RPA_D)
...
P1 = Heatmap_Parameters(1,:);  %Temp. variable (for L_RPA) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    L_RPA = P1(Simulations); %concentration of RPA
    k_off_RPA_D = P2(Simulations);    %kinetic rate constant for unbinding of RPA-A
...
[X_Heatmap,Y_Heatmap] = meshgrid(L_RPA_Values,k_off_RPA_D_Values); %generates X and Y values for heatmaps
