...
% w_RAD51 and k_on_RPA_A. It allows for plotting the growth 
...
k_on_RPA_A_Values = linspace(1,100,2); %kinetic rate constant for RPA-A binding to ssDNA
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(w_RAD51_Values,k_on_RPA_A_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: w_RAD51 and k_on_RPA_A)
...
P2 = Heatmap_Parameters(2,:);  %Temp. variable (for k_on_RPA_A) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_on_RPA_A = P2(Simulations);    %concentration of RPA
...
[X_Heatmap,Y_Heatmap] = meshgrid(w_RAD51_Values,k_on_RPA_A_Values); %generates X and Y values for heatmaps
