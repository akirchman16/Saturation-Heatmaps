...
% L_RAD51_Total and L_RPA. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(L_RAD51_Total_Values,L_RPA_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: L_RAD51_Total and L_RPA)
...
[X_Heatmap,Y_Heatmap] = meshgrid(L_RAD51_Total_Values,L_RPA_Values); %generates X and Y values for heatmaps
