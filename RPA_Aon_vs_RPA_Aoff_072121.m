...
% k_on_RPA_A and k_off_RPA_A. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(k_on_RPA_A_Values,k_off_RPA_A_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: k_on_RPA_A and k_off_RPA_A)
...
[X_Heatmap,Y_Heatmap] = meshgrid(k_on_RPA_A_Values,k_off_RPA_A_Values); %generates X and Y values for heatmaps
