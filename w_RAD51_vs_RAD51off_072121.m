...
% w_RAD51 and k_off_RAD51. It allows for plotting the growth 
...
w_RAD51_Values = linspace(1,10,2);    %cooperativity parameter for RAD51
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(w_RAD51_Values,k_off_RAD51_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: w_RAD51 and k_off_RAD51)
...
P1 = Heatmap_Parameters(1,:);  %Temp. variable (for w_RAD51) to avoid high, over-necessary communication in parfor of Parameters
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    w_RAD51 = P1(Simulations); %cooperativity parameter for RAD51
    k_off_RAD51 = P2(Simulations);    %kinetic rate constant for unbinding of RAD51
...
[X_Heatmap,Y_Heatmap] = meshgrid(w_RAD51_Values,k_off_RAD51_Values); %generates X and Y values for heatmaps
