...
% k_off_RAD51 and k_on_RPA_D. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(k_off_RAD51_Values,k_on_RPA_D_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: k_off_RAD51 and k_on_RPA_D)
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_off_RAD51 = P1(Simulations); %kinetic rate constant for binding of RAD51
...
[X_Heatmap,Y_Heatmap] = meshgrid(k_off_RAD51_Values,k_on_RPA_D_Values); %generates X and Y values for heatmaps
