...
L_RAD51_Total_Values = linspace(0.5,2,4);  %total concentration of RAD51 in solution
Percent_M_RAD51_Values = linspace(0,1,4);    %percentage of RAD51 solution which is monomers
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    % Equilibrium Testing - Linear Slope & Intercept Method %%%%%%%%%%%%%%%%%%%
        ...
        RAD51_Dim_BoundAtSpot = []; %clears record of currently bound RAD51 dimers
