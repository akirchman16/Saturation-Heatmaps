...
% w_RAD51 and k_on_RPA_D. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(w_RAD51_Values,k_on_RPA_D_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: w_RAD51 and k_on_RPA_D)
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    k_on_RPA_D = P2(Simulations);    %kinetic rate constant for binding of RPA-A
...
[X_Heatmap,Y_Heatmap] = meshgrid(w_RAD51_Values,k_on_RPA_D_Values); %generates X and Y values for heatmaps
