...
% sets. Requires multiple values for a parameter (any parameter other than
% RPA cooperativity). Once this system is sufficient, then it will be used
...
Parameter_Name = {'RAD51 Total Concentration (L_R_A_D_5_1)', 'RAD51 Monomer % (\rho)','RAD51 Cooperativity (\omega_R_A_D_5_1)','RAD51 k_o_n','RAD51 k_o_f_f','RPA Concentration (L_R_P_A)','RPA-A k_o_n','RPA-D k_o_n','RPA-A k_o_f_f','RPA-D k_o_f_f'};    %names of all parameters (shows on graphs)
