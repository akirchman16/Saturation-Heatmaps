...
Changing_Parameter = find(any(diff(Parameters,1,2)) ~= 0);  %row in Parameters vector that corresponds to the changing parameter

figure;
scatter(Parameters(Changing_Parameter),RPA_Avg_Saturation,3,'m','filled');  %equilibrium saturation values for RPA
hold on;
scatter(Parameters(Changing_Parameter),RAD51_Avg_Saturation,3,'r','filled'); %equilibrium saturation values for RAD51
scatter(Parameters(Changing_Parameter),RPA_Avg_Saturation+RAD51_Avg_Saturation,3,'k','filled'); %equilibrium saturation values for total saturation
