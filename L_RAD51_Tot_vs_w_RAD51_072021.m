...
L_RAD51_Total_Values = [1,10];  %total concentration of RAD51 in solution
Percent_M_RAD51 = 0.5;    %percentage of RAD51 solution which is monomers
w_RAD51_Values = [1,10];    %cooperativity parameter for RAD51
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(L_RAD51_Total_Values,w_RAD51_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: L_RAD51_Total and w_RAD51)
...
parfor Simulations = 1:(numel(Heatmap_Parameters)/2)
    ...
    w_RAD51 = P2(Simulations);    %percentage of RAD51 solution which is monomers
...
[X_Heatmap,Y_Heatmap] = meshgrid(L_RAD51_Total_Values,w_RAD51_Values); %generates X and Y values for heatmaps
