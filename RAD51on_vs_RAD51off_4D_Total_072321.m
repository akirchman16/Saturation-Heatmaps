...
k_on_RAD51_Values = linspace(0.2,10,50);     %kinetic rate constant for RAD51 binding to ssDNA
k_off_RAD51_Values = linspace(0.2,10,50);    %kinetic rate constant for RAD51 dissociating from ssDNA
