...
% L_RAD51_Total and k_on_RPA_A. It allows for plotting the growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Heatmap_Parameters = combvec(L_RAD51_Total_Values,k_on_RPA_A_Values);   %combination of possible sets of parameters that will generate heatmap (for this instance: L_RAD51_Total and k_on_RPA_A)
...
[X_Heatmap,Y_Heatmap] = meshgrid(L_RAD51_Total_Values,k_on_RPA_A_Values); %generates X and Y values for heatmaps
